...
public class TestCalculation {
	...
	public void testCalculationComp1Veh1_18() {
		...
		assertEquals(8119.0, calculation1.calculate(TestVehicle.vehicle9, TestCompany.company1),0.1);//We set delta to 0.1 to prevent precision issues.
		...
		assertEquals(3550.0, calculation1.calculate(TestVehicle.vehicle13, TestCompany.company1),0.1);//We set delta to 0.1 to prevent precision issues.
		assertEquals(3690.0, calculation1.calculate(TestVehicle.vehicle14, TestCompany.company1),0.1);//We set delta to 0.1 to prevent precision issues.
